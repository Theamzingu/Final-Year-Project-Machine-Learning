...
class DQN(nn.Module):
    ...
    def __init__(self, n_observations, n_actions):
        ...
        self.layer15 = nn.Linear(512, 512)
        self.layer16 = nn.Linear(512, 512)
        self.layer17 = nn.Linear(512, 512)
        self.layer18 = nn.Linear(512, 512)
        self.layer19 = nn.Linear(512, 512)
        self.layer20 = nn.Linear(512, 512)
        self.layer21 = nn.Linear(512, 512)
        self.layer22 = nn.Linear(512, 512)
        self.layer23 = nn.Linear(512, 512)
        self.layer24 = nn.Linear(512, 512)
        self.layer25 = nn.Linear(512, 512)
        self.layer26 = nn.Linear(512, n_actions)
